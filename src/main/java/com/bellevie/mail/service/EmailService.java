package com.bellevie.mail.service;
...
import com.bellevie.mail.sdo.EmailAuthenticator;
import com.bellevie.mail.utils.EmailProperties;
...
public class EmailService {
	...
	public static void main(String args[]) {
		String emailTo = "chinadx@qq.com";
		String subject = "test";
		String content = "测试邮件";
		send(emailTo, content, subject);
	}
}